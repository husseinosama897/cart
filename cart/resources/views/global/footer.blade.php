<footer>
    <div class="container">
        <div class="menu row">
            <div class="col-xl-2 ms-lg-4 mb-4 col-lg-3 col-md-4 col-sm-6 col-6">
                <h5>عن الشركة</h5>
                <ul class="px-0">
                    <li>
                        <a href="#">
        ...
        <div class="social-media">
            <div class="we-accept">
                <span>نحن نقبل</span>
                <div class="d-flex">
                    <img src="https://www.freepnglogos.com/uploads/verified-by-visa-logo-png-0.png" width="80" alt="">
                    <img src="https://www.freepnglogos.com/uploads/verified-by-visa-logo-png-0.png" width="80" alt="">
                </div>
            </div>
            <div class="follow-us">
                ...
                <div class="d-flex">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M15.402 21v-6.966h2.333l.349-2.708h-2.682V9.598c0-.784.218-1.319 1.342-1.319h1.434V5.857a19.19 19.19 0 0 0-2.09-.107c-2.067 0-3.482 1.262-3.482 3.58v1.996h-2.338v2.708h2.338V21H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-4.598z"></path></svg>
                    </a>
                    <a href="#">
...
<div class="copyright">
    <div class="container">
        <span>جميع الحقوق محفوظة لدي 2022</span>
    </div>
</div>