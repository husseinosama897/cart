...
<div class="page-header">
    <h1 class="page-title">تعديل القسم {{ $category->name }}</h1>
</div>
                ...
                <form method="POST" action="{{ route('category_update', $category->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ $category->name }}" placeholder="الاسم">
                        </div>
                        <div class="form-group">
                            <label for="demo" class="form-label">الصورة</label>
                            <input id="" type="file" name="image" accept=".jpg, .png, image/jpeg, image/png" value="{{ $category->image }}">
                        </div>
                    </div>
