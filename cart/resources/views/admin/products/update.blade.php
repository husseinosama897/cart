                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <select name="qty_type" class="form-control form-select select2" data-bs-placeholder="Select Country">
                                    <option value="1" {{ $product->qty_type == '1' ? 'selected' : '' }}>عدد عادي</option>
                                    <option value="2" {{ $product->qty_type == '2' ? 'selected' : '' }}>عدد لانهائي</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <select name="option" class="form-control form-select select2" data-bs-placeholder="Select Country">
                                <option value="1" {{ $product->option == '1' ? 'selected' : '' }}>القطعه</option>
                                <option value="2" {{ $product->option == '2' ? 'selected' : '' }}>الجمله</option>
                        </select>
                        </div>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <select name="supplier_id" class="form-control form-select select2" data-bs-placeholder="Select Country">
                                ...
                                <option value="{{ $item->id }}" {{ $product->supplier_id == $item->id ? 'selected' : '' }}>{{ $item->comp }}</option>
                                @endforeach
                        </select>
                        </div>
                    </div>
