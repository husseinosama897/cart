         ...
         <div class="container">
            <div class="row">
               <aside class="col-lg-8">
                  <div class="card cart">
                     <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom card_details">
                        <div class="d-block d-sm-flex align-items-center text-center text-sm-right">
                           <a class="d-inline-block flex-shrink-0 mx-auto ml-sm-4 mr-sm-4" href="shop-single-v1.html">
                           <img src="https://www.pomegy.com/images/products/1650826829.He717e32048c74bd390d18d655ca5066cB.jpg" width="120" alt="Product">
                           </a>
                           <div class="pt-2">
                              ...
                              <div class="fs-sm mb-1">
                                 <span class="text-muted me-2 price">سعر المنتج : </span>  5750
                              </div>
                           </div>
                        </div>
                        <div class="pt-2 pt-sm-0 pe-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                           ...
                           <input class="form-control qty" type="number" id="quantity" min="1" value="1" style="padding: 10px;border-radius: 2px;width: 100px;height: 36px;">
                           <a class="btn px-0 text-danger remove" style="cursor: pointer">
