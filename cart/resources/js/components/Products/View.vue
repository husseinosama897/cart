  ...
  <div>
      <div class="container">
        <div class="product-details">
            <div class="row">
                <div class="photos col-lg-4 owl-carousel">
                    <img 
...
object-fit: contain;">
                ...
                <div class="details col-lg-8">
                    ...
                    <span class="col-lg-3 mb-2">السعر : {{ product.price }} ر.س</span>
                    <div class="qty col-lg-3">
                    ...
                    <div class="baw mb-4">
                        <button class="btn btn-sm btn-primary py-2 px-2 mx-1 mb-2">
                        ...
                        <button class="btn btn-sm btn-primary py-2 px-2 mx-1 mb-2" @click="addProductInCart(product.id)">
                        ...
                        <button class="btn btn-sm btn-primary py-2 px-2 mx-1">
    ...
    <div class="mb-8">
        ...
        <!-- Tab Content -->
        <div class="borders-radius-17 border p-4 mt-4 mt-md-0">
            ...
            <div class="row">
                <div class="product" v-for="(relatedProduct, index) in related" :key="index">
                    ...
                    <div class="details">
                        ...
                        <button class="supplier-cart" @click="addRelatedProductInCart(relatedProduct.id)">
...
export default {
    ...
    methods: {
        ...
        addRelatedProductInCart: function($product){
            axios.post('/storeincart/'+ $product, {
                'quantity': 1,
            })
            .then((response) => {
